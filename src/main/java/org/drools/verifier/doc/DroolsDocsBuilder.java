...
public class DroolsDocsBuilder {
	 private static final Font   Table_TITLE      = FontFactory.getFont("STSongStd-Light" , "UniGB-UCS2-H", BaseFont.NOT_EMBEDDED,20, Font.BOLD);
...
//            document.add( new Phrase( "Table of Contents" ) );
            document.add( new Phrase(DroolsDocConstant.TABLEOFCONTENTS,Table_TITLE) );
